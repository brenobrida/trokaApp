...
Widget wrapWithModel<T extends trokaModel>({
  required T model,
...
T createModel<T extends trokaModel>(
...
abstract class trokaModel<W extends Widget> {
...
class trokaDynamicModels<T extends trokaModel> {
  trokaDynamicModels(this.defaultBuilder);
