...
class trokaDropDown<T> extends StatefulWidget {
  const trokaDropDown({
    super.key,
    this.controller,
  ...
  @override
  State<trokaDropDown<T>> createState() => _trokaDropDownState<T>();
}

class _trokaDropDownState<T> extends State<trokaDropDown<T>> {
