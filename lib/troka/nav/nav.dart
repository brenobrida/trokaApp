...
import '/troka/lat_lng.dart';
import '/troka/place.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'updateUserInfo',
          path: '/updateUserInfo',
          builder: (context, params) => UpdateUserInfoWidget(),
        ),
        FFRoute(
          name: 'inserir',
          path: '/inserir',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'inserir')
              : InserirWidget(),
        ),
        FFRoute(
          name: 'meusObjetos',
          path: '/meusObjetos',
          builder: (context, params) => MeusObjetosWidget(),
        ),
        FFRoute(
          name: 'explorar',
          path: '/explorar',
        ...
        FFRoute(
          ...
          path: '/ofertas',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ofertas')
              : OfertasWidget(),
        ),
        FFRoute(
          name: 'objectPage',
        ...
        FFRoute(
          name: 'systemSugestions',
          path: '/systemSugestions',
          builder: (context, params) => SystemSugestionsWidget(),
        ),
        FFRoute(
          name: 'chat',
          path: '/chat',
