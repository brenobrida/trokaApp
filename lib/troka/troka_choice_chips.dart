...
class trokaChoiceChips extends StatefulWidget {
  const trokaChoiceChips({
    super.key,
  ...
  @override
  State<trokaChoiceChips> createState() => _trokaChoiceChipsState();
}

class _trokaChoiceChipsState extends State<trokaChoiceChips> {
