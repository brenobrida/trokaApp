...
class trokaIconButton extends StatefulWidget {
  const trokaIconButton({
    Key? key,
    required this.icon,
    this.borderColor,
    this.borderRadius,
  ...
  @override
  State<trokaIconButton> createState() => _trokaIconButtonState();
}

class _trokaIconButtonState extends State<trokaIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(trokaIconButton oldWidget) {
