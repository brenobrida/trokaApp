...
import 'inserir_widget.dart' show InserirWidget;
...
class InserirModel extends trokaModel<InserirWidget> {
  ...
  ApiCallResponse? localizationConsulted1Copy;
  // Stores action output result for [Backend Call - API (CEP)] action in Button widget.
  ApiCallResponse? localizationConsulted2Copy;
  // Stores action output result for [Backend Call - API (CEP)] action in Button widget.
  ApiCallResponse? localizationConsulted3Copy;
