...
import 'editar_objeto_model.dart';
export 'editar_objeto_model.dart';

class EditarObjetoWidget extends StatefulWidget {
  const EditarObjetoWidget({super.key});

  @override
  State<EditarObjetoWidget> createState() => _EditarObjetoWidgetState();
}

class _EditarObjetoWidgetState extends State<EditarObjetoWidget> {
  late EditarObjetoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarObjetoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'editarObjeto'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UserObjectsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserObjectsRecord> editarObjetoUserObjectsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editarObjetoUserObjectsRecord =
            editarObjetoUserObjectsRecordList.isNotEmpty
                ? editarObjetoUserObjectsRecordList.first
                : null;
                ...
                actions: [
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'EDITAR_OBJETO_PAGE_Icon_t8n9x0jn_ON_TAP');
                        ...
                        if (confirmDialogResponse) {
                          ...
                          await editarObjetoUserObjectsRecord!.reference
                              .delete();
                        } else {
                          return;
                        }
                      ...
                      children: [
                        Padding(
                          ...
                          child: SwitchListTile.adaptive(
                            value: _model.switchListTileValue1 ??=
                                editarObjetoUserObjectsRecord!.available,
                          ...
                          child: Padding(
                            ...
                            child: trokaChoiceChips(
                              ...
                              controller: _model.choiceChipsValueController ??=
                                ...
                                [
                                  editarObjetoUserObjectsRecord!.negotiationType
                                ],
                              ),
                              wrapped: false,
                            ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textController1 ??=
                                ...
                                text: editarObjetoUserObjectsRecord?.title,
                              ),
                          ...
                          child: trokaDropDown<String>(
                            controller: _model.dropDownValueController1 ??=
                              ...
                              _model.dropDownValue1 ??=
                                  editarObjetoUserObjectsRecord?.objectCategory,
                            ),
                            options: [
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textController2 ??=
                                  TextEditingController(
                                text:
                                    editarObjetoUserObjectsRecord?.description,
                              ),
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              controller: _model.textController3 ??=
                                  TextEditingController(
                                text: editarObjetoUserObjectsRecord?.cep,
                              ),
                            ...
                            child: CarouselSlider(
                              items: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDITAR_OBJETO_PAGE_Image_6ebfw0p8_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDITAR_OBJETO_PAGE_Image_7mkidz8e_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDITAR_OBJETO_PAGE_Image_u938puzp_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDITAR_OBJETO_PAGE_Image_3q9dsreu_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDITAR_OBJETO_PAGE_Image_aecuznsd_ON_TAP');
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'EDITAR_OBJETO_PAGE_Image_u2xgmcqv_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: SwitchListTile.adaptive(
                              value: _model.switchListTileValue2 ??=
                                  editarObjetoUserObjectsRecord!.anyCategory,
                              onChanged: (newValue) async {
                                setState(() =>
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDITAR_OBJETO_PAGE_SALVAR_BTN_ON_TAP');
                              ...
                              if ((_model.choiceChipsValue == null ||
                                ...
                                if (_model.choiceChipsValue == 'doação') {
                                  ...
                                  await editarObjetoUserObjectsRecord!.reference
                                    ...
                                    photo1:
                                        editarObjetoUserObjectsRecord?.photo1,
                                    photo2:
                                        editarObjetoUserObjectsRecord?.photo2,
                                    photo3:
                                        editarObjetoUserObjectsRecord?.photo3,
                                    photo4:
                                        editarObjetoUserObjectsRecord?.photo4,
                                    photo5:
                                        editarObjetoUserObjectsRecord?.photo5,
                                    cidade: getJsonField(
                                  ...
                                  if (_model.checkboxGroupValues != null &&
                                    ...
                                    await editarObjetoUserObjectsRecord!
                                        .reference
                                        .update({
                                      ...createUserObjectsRecordData(
                                        ...
                                        uid: currentUserUid,
                                        photo0: FFAppState().photo0,
                                        photo1: editarObjetoUserObjectsRecord
                                            ?.photo1,
                                        photo2: editarObjetoUserObjectsRecord
                                            ?.photo2,
                                        photo3: editarObjetoUserObjectsRecord
                                            ?.photo3,
                                        photo4: editarObjetoUserObjectsRecord
                                            ?.photo4,
                                        photo5: editarObjetoUserObjectsRecord
                                            ?.photo5,
                                        cidade: getJsonField(
                                          (_model.localizationConsul3
                                                  ?.jsonBody ??
